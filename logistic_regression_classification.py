...
# using stratification and 80/20 pct. split between respectively training and test 
K = 20
...
lambda_interval = np.logspace(-6, 3, 50)
...
print("acc_score: ", accuracy_score(y_test_est,y_test))
...
print("baseline score: ", baseline_clf.score(X,y))
print("baeline accuracy_score: ", accuracy_score(y_test_est_base,y_test))
